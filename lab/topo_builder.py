...
class TopoBuilder(Topo):
    def build(self):
        ...
        h1s1 = self.addHost('h1s1', ip='172.16.1.1/8', xterm='xterm h1s1')
        h2s1 = self.addHost('h2s1', ip='172.16.1.2/8', xterm='xterm h2s1')
        h3s1 = self.addHost('h3s1', ip='172.16.1.3/8', xterm='xterm h3s1')
        ...
        h1s3 = self.addHost('h1s3', ip='172.16.1.7/8', xterm='xterm h1s3')
        h2s3 = self.addHost('h2s3', ip='172.16.1.8/8', xterm='xterm h2s3')
        h3s3 = self.addHost('h3s3', ip='172.16.1.9/8', xterm='xterm h3s3')
